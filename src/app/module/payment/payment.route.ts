...
router.post("/create-session", checkAuth(Role.USER, Role.ADMIN), PaymentController.createPaymentSession);
...
// payment history
router.get("/my", checkAuth(Role.USER, Role.ADMIN), PaymentController.getMyPayments);
